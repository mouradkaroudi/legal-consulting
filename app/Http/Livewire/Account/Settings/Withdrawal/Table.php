...
namespace App\Http\Livewire\Account\Settings\Withdrawal;
...
class Table extends Component implements HasTable
{
        ...
        return [
            Tables\Actions\EditAction::make('add')
                ->action(function ($record, $data) {
                    ...
                    $withdrawals = $user->withdrawal_methods ?? [];
                    ...
                    $user->withdrawal_methods = $withdrawals;
                    $user->save();
                })
                ->mountUsing(function (Forms\ComponentContainer $form, $record) {

                    $withdrawals = auth()->user()->withdrawal_methods ?? [];
                    $data = [
                        "method_id" => $record->id
                    ];
    ...
    {
        return view('livewire.account.settings.withdrawal.table');
    }
}
