...
use App\Http\Middleware\DigitalOffice;
...
return [
    ...
    */
    ...
    'pages' => [
        ...
        'path' => app_path('FilamentDigitalOffice/Pages'),
        'register' => [
    ...
    */
    ...
    'resources' => [
        ...
        'path' => app_path('FilamentDigitalOffice/Resources'),
        'register' => [],
    ],
    ...
    */
    ...
    'widgets' => [
        'namespace' => 'App\\FilamentDigitalOffice\\Widgets',
        'path' => app_path('FilamentDigitalOffice/Widgets'),
        'register' => [
    ...
    */
    ...
    'livewire' => [
        'namespace' => 'App\\FilamentDigitalOffice',
        'path' => app_path('FilamentDigitalOffice'),
    ],
