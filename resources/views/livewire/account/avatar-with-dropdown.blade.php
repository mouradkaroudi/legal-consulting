...
<div class="relative" x-data="{ isOpen: false }">
    ...
    >
        ...
        <a href="{{ route('account.settings') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-0">
            {{ __('Account settings') }}
        </a>

        <a href="{{ route('account.balance') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item-1">
            {{ __('Balance', ['balance' => money($user->available_balance, 'sar', true)]) }}
        </a>
