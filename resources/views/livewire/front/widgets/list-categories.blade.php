<div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
    ...
    <div class="space-y-3 border rounded-lg p-4 hover:border-gray-300">
        ...
        <a href="{{ route('search.listing', ['service' => $service->slug]) }}" class="inline-flex items-center -mx-1 text-sm text-blue-500 capitalize transition-colors duration-300 transform dark:text-blue-400 hover:underline hover:text-blue-600 dark:hover:text-blue-500">
