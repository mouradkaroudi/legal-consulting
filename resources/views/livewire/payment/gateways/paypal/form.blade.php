<form x-show="open" x-cloak wire:submit.prevent="submit">
    <p class="mb-2 text-gray-700">
        {{ __("You'll be redirected to PayPal website to complete your purchase securely") }}.
    </p>
    <button type="submit" class="w-full text-gray-900 bg-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-4 focus:ring-[#F7BE38]/50 rounded-lg px-5 py-3 font-bold text-base inline-flex justify-center items-center gap-4">
        <svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
        ...
        <span>{{ __('Checkout with PayPal') }}</span>
    </button>
