        ...
        <div class="min-w-full border rounded lg:grid lg:grid-cols-3">
            <div class="border-r border-gray-300 lg:col-span-1">
                ...
                <ul class="overflow-auto h-[32rem]">
                    <h2 class="my-2 mb-2 mr-2 text-lg text-gray-600">Chats</h2>
                    <li>
                        <a class="flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
                            ...
                            <div class="w-full pb-2">
                                <div class="flex justify-between">
                                    <span class="block mr-2 font-semibold text-gray-600">Jhon Don</span>
                                    <span class="block mr-2 text-sm text-gray-600">25 minutes</span>
                                </div>
                                <span class="block mr-2 text-sm text-gray-600">bye</span>
                            </div>
                        </a>
                        <a class="flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out bg-gray-100 border-b border-gray-300 cursor-pointer focus:outline-none">
                            ...
                            <div class="w-full pb-2">
                                <div class="flex justify-between">
                                    <span class="block mr-2 font-semibold text-gray-600">Same</span>
                                    <span class="block mr-2 text-sm text-gray-600">50 minutes</span>
                                </div>
                                <span class="block mr-2 text-sm text-gray-600">Good night</span>
                            </div>
                        </a>
                        <a class="flex items-center px-3 py-2 text-sm transition duration-150 ease-in-out border-b border-gray-300 cursor-pointer hover:bg-gray-100 focus:outline-none">
                            ...
                            <div class="w-full pb-2">
                                <div class="flex justify-between">
                                    <span class="block mr-2 font-semibold text-gray-600">Emma</span>
                                    <span class="block mr-2 text-sm text-gray-600">6 hour</span>
                                </div>
                                <span class="block mr-2 text-sm text-gray-600">Good Morning</span>
                            </div>
                        </a>
                    </li>
                </ul>
            ...
            <div class="hidden lg:col-span-2 lg:block">
                <div class="w-full">
                    <div class="relative flex items-center p-3 border-b border-gray-300">
                        <img class="object-cover w-10 h-10 rounded-full" src="https://cdn.pixabay.com/photo/2018/01/15/07/51/woman-3083383__340.jpg" alt="username" />
                        <span class="block mr-2 font-bold text-gray-600">محمد الفكير</span>
                        <span class="absolute w-3 h-3 bg-green-600 rounded-full right-10 top-3">
                        </span>
                    </div>
