...
<div class="flex w-full">
        ...
        <div class="mr-3 text-sm font-normal">
            ...
            <div class="mb-2 text-sm font-normal">تمت دعوتك للإنظمام لمكتب <span class="font-bold">{{ $office->name }}</span></div> 
            <div class="flex flex-wrap items-center gap-4 justify-start">
                <livewire:account.invites.accept-button />
                <livewire:account.invites.decline-button />
            </div>    
        </div>
