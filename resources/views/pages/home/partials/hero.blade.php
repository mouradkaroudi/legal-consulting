<div class="relative">
    <img src="https://images.pexels.com/photos/7984741/pexels-photo-7984741.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" class="absolute inset-0 object-cover w-full h-full" alt="" />
            ...
            <div class="flex flex-col items-center justify-between xl:flex-row">
                <div class="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                    <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-white sm:text-4xl sm:leading-none">
                        المساعدة القانونية بنقرة واحدة
                    </h2>
                    <p class="max-w-xl mb-4 text-base text-gray-200 md:text-lg">
                        تحدث مع أحد محامينا ، واطرح الأسئلة ، واحصل على إجابات - كل ذلك في الوقت الفعلي. </p>
