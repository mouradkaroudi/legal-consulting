...
<body class="antialiased bg-gray-100">
    ...
    <div class="max-w-lg mx-auto">
        <h1 class="text-3xl font-bold mb-2">التحويل البنكي</h1>
        <p class="mb-6 text-xl">
            قم بتحويل المبلغ الذي تريد شحن بحسابك الى الحساب البنكي . <span class="block mt-4 text-center bg-gray-200 rounded-full p-2">{{ get_option('transactions_bank_rib') }}</span>
        </p>
        <x-filament::card>
